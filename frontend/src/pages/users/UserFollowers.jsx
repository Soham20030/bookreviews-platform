    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: '#d32f2f', marginBottom: '1rem' }}>Error Loading Followers</h2>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              {profileUser && `People following ${profileUser.display_name || profileUser.username}`}
            </p>
          </div>
        </div>
      ...
      {followers.length === 0 ? (
        <div style={{
          ...
          <p style={{
            ...
            {profileUser && `${profileUser.display_name || profileUser.username} hasn't gained any followers yet.`}
          </p>
        </div>
      ) : (
        <div style={{
